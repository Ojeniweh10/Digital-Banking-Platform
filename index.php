    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <i class="fas fa-phone-alt"></i> +44 7911 123456
                            </a>
                        </li>
                    </ul>
                    <a class="btn btn-danger" href="client/pages_client_signup.php" target="_blank">Join Us</a>
                    <a class="btn btn-success" href="#" onclick="window.open('http://localhost/chatbot/', 'chatbotWindow', 'width=400,height=600'); return false;">Live Chat</a>
                </div>
            </div>
        </nav>
        ...
        <div class="intro py-5 py-lg-9 position-relative text-white">
            <div class="bg-overlay-gray">
                <img src="dist/credit-card-online-shopping-payment_117856-1629.jpg" class="img-fluid img-cover"/>
            </div>
