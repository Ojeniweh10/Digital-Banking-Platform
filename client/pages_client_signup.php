    ...
    <div class="login-box">
      ...
      <div class="card">
        <div class="card-body login-card-body">
          <p class="login-box-msg">Sign Up For IBanking with Bytebank</p>
          ...
          <form method="post">
            ...
            <div class="input-group mb-3">
              <input type="text" required name="national_id" class="form-control" placeholder="National ID No or Tax Clearance">
              <div class="input-group-append">
                <div class="input-group-text">
